...
credits.Text = "Feito por Reaper Xploits & NovaheX"
...
local function createCommand(name, action)
    ...
    btn.Position = UDim2.new(0, 0, 0, content:GetChildren()[#content:GetChildren()].Position.Y.Offset + 40)
    btn.Text = name
